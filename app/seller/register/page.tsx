...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-slate-50/50" dir="ltr">
          ...
          <div className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-11 pr-4 py-3.5 border border-slate-200 rounded-xl text-sm text-slate-900 bg-slate-50 focus:bg-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition-all"
            ...
            <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 grid grid-cols-2 gap-y-3 gap-x-2">
              <PolicyItem isValid={hasMinLength} text="Min 6 characters" />
              <PolicyItem isValid={hasUpperCase} text="Uppercase (A-Z)" />
              <PolicyItem isValid={hasLowerCase} text="Lowercase (a-z)" />
              <PolicyItem isValid={hasNumber} text="Number (0-9)" />
              <div className="col-span-2">
                <PolicyItem isValid={hasSpecialChar} text="Special character (!@#...)" />
              </div>
            </div>
